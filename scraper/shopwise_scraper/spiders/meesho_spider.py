...
class MeeshoSpider(scrapy.Spider):
    ...
    def parse(self, response, **kwargs):  # type: ignore
        self.log(f"Parsing mock Meesho listing data from {response.url}...")
        ...
        mock_products = [
            {
                ...
                'seller_name': 'Meesho',
                'seller_url': 'https://meesho.example.com/samsung-galaxy-watch-6',
                'price': 18999.00,
                'currency': 'INR',
                'rating': 4.1,
                'review_count': 34,
                'reviews': [
                    {
                        ...
                        'rating': 4,
                        'review_text': 'Affordable deal on watch. Genuine product.'
                    }
                ]
            }
        ]
